...
//
// для решение данной слау (столбец) необходимо рассчитывать значения альфа и К
// они в свою очерель зависят от Q, E (дано), Г - парметр неидеальности, поправка
// Q ищется с помощью интерполяции методом полинома Ньютона 2 степени
